...
public class OrderTableDao {
	private static final String INSERT_ORDER = "INSERT INTO ORDERTABLE(order_id, user_id, rice_id, order_quantity, order_amount) VALUES(?, ?, ?, ?, ?)";
	...
	public void  InsertOrder(int order_id, int user_id, int rice_id, int order_quantity, int order_amount) {
		try {
