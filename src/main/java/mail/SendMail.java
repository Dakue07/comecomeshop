...
public class SendMail {
	public static void sendMail(int user_id, int order_id) {
	    ...
	    try {
	        ...
	        // メール内容
	        message.setText("注文番号" + order_id + "<br>購入時間" + useraddressorderdto.getOrder_time() + "住所" + useraddressorderdto.getUseraddress_postcode() + useraddressorderdto.getUseraddress_state_city() + useraddressorderdto.getUseraddress_street());
