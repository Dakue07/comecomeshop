  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary full-width">
        ...
        <a class="navbar-brand ms-3" href="#">
          <img src="/comecomeshop/images/logo.png" alt="Bootstrap" width="150" height="80">
        </a>
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav nav-underline ms-auto grid gap-3">
              <!-- 検索form -->
              <form class="d-flex flex-row me-3" role="search">
                <input class="form-control me-2" type="search" placeholder="Enter content..." aria-label="Search">
